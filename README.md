...
int main() {
  char msg[] = "HEMASREE", enc[100], dec[100];
  hill(msg, enc, 1); printf("Encrypted: %s\n", enc);
  hill(enc, dec, 0); printf("Decrypted: %s\n", dec);
}
```
## OUTPUT
<img width="1913" height="1154" alt="image" src="https://github.com/user-attachments/assets/79e3dfd9-3531-450c-84f5-34c0d6c95cca" />
